...
```{r radial-images, echo = FALSE, message=FALSE, warning=FALSE, fig.show="hold", out.width=c('33%', '33%','33%')}
...
```{r rosella_img, echo = FALSE, message=FALSE, warning=FALSE, fig.show="hold", out.width=c('25%', '25%','25%', '25%')}
